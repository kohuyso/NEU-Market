			...
			<div className='payment-wrapper'>
				<div className="address-item">
					...
					<div className="content-item">
						...
						<div className="right-content-item">
							<Button variant='outlined' variant='outlined' style={{ textTransform: "none", fontSize: 15 }}>Thay đổi</Button>
						</div>
					</div>
				</div>
				...
				<div className='payment-method'>
					...
					<div className='payment-methods'>
						<Button variant='outlined' sx={{mr: 2}} style={{ textTransform: "none", fontSize: 15 }}>Thanh toán ngân hàng</Button>
						<Button variant='outlined' style={{ textTransform: "none", fontSize: 15 }}>Thanh toán khi nhận hàng</Button>
					</div>
				</div>
			</div>
			<Footer/>
