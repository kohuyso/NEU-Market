        ...
        <div className="my-details-general">
          ...
          <div className="my-details-general-content">
            ...
            <div className="right">
              ...
              <TextField sx={{mb: 2}} label="Current Password" variant="outlined" type="password"/>
              <TextField sx={{mb: 2}} label="New Password" variant="outlined" type="password"/>
              <TextField sx={{mb: 2}} label="Confirm Password " variant="outlined" type="password"/>
            </div>
          </div>
        </div>
