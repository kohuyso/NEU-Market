...
import { addProduct, setName, setType, setGender, setDescription, setSize, setExpirationDate, setFieldName, setFieldValue } from "../../redux/reducers/productSlice";
...
export default function AddProduct() {
  ...
  const onAddField = () => {
    ...
    //   })
    // );
    setValue({...newProduct, fields: newProduct.fields.push({name: "", value: ""})});
  };
