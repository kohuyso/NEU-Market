...
export default function MyAddress() {
  ...
  const [city, setCity] = React.useState(newAddress.city);
  const [districts, setDistricts] = React.useState([]);
  const [district, setDistrict] = React.useState(newAddress.district);
	const [wards, setWards] = React.useState([]);
  const [ward, setWard] = React.useState(newAddress.ward);
