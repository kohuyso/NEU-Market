...
export const { addProduct, addImg, removeImg, addField, setName, setType, setGender, setSize, setDescription, setExpirationDate, setFieldName, setFieldValue } = productSlice.actions
