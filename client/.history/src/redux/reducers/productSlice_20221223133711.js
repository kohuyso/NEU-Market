...
export const { addImg, removeImg, addField, removeField, setName, setType, setGender, setFieldName, setFieldValue, setDescription, setSize, setExpirationDate } = productSlice.actions
